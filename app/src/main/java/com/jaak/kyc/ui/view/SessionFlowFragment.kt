...
import com.jaak.kyc.databinding.FragmentSessionFlowBinding
...
class SessionFlowFragment : Fragment() {
     ...
     */
    private fun filterAndGroupEvents(events: List<com.jaak.kyc.data.model.api.SessionDetailFlowEvent>): List<com.jaak.kyc.data.model.api.SessionDetailFlowEvent> {
        val filteredList = mutableListOf<com.jaak.kyc.data.model.api.SessionDetailFlowEvent>()
