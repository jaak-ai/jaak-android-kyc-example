...
import com.jaak.kyc.databinding.ActivityOtoDetailBinding
import com.jaak.kyc.ui.adapter.ComparisonAdapter
import com.jaak.kyc.ui.adapter.ImageQualityAdapter
import com.jaak.kyc.ui.adapter.PropertyResultAdapter
...
class OtoDetailActivity : AppCompatActivity() {
    ...
    private fun loadOtoData() {
        ...
        val otoData = intent.getParcelableExtra<com.jaak.kyc.data.model.OtoDetailData>("oto_data")
