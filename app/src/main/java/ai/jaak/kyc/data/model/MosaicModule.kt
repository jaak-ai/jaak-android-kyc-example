...
data class MosaicConfig(
     ...
     * @param mosaicBaseUrl URL base de Mosaic según el perfil (ej: "https://mosaic.jaak.ai/")
     */
    fun buildMosaicUrl(mosaicBaseUrl: String): String {
        ...
        return "${mosaicBaseUrl}link?shortKey=$shortKey&steps=$stepsParam"
    }
