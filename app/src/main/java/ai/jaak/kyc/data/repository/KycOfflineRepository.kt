...
class KycOfflineRepository @Inject constructor(
    ...
    private suspend fun executeBlacklistServices(processId: String, accessToken: String) {
        try {
            ...
            val ocrResponse = try {
                com.google.gson.Gson().fromJson(ocrResponseJson, ai.jaak.kyc.data.model.ocr.v4.DocumentExtractV4Response::class.java)
            } catch (e: Exception) {
            ...
            val payload = ai.jaak.kyc.utils.BlacklistRequestBuilder.createPayloadFromDocumentExtract(ocrResponse)
            ...
            try {
                ...
                val ineRequest = ai.jaak.kyc.utils.BlacklistRequestBuilder.createIneRequest(payload)
            ...
            try {
                ...
                val interpolRequest = ai.jaak.kyc.utils.BlacklistRequestBuilder.createInterpolRequest(payload)
            ...
            try {
                ...
                val ofacRequest = ai.jaak.kyc.utils.BlacklistRequestBuilder.createOfacRequest(payload)
            ...
            try {
                ...
                val renapoRequest = ai.jaak.kyc.utils.BlacklistRequestBuilder.createRenapoRequest(payload)
            ...
            try {
                ...
                val satRequest = ai.jaak.kyc.utils.BlacklistRequestBuilder.createSatRequest(payload)
