...
import ai.jaak.kyc.notification.NotificationActionReceiver
import ai.jaak.kyc.ui.view.KycProcessesActivity
import ai.jaak.kyc.ui.view.KycSyncActivity
...
class NotificationService @Inject constructor(
    ...
    companion object {
        const val ACTION_RETRY_SYNC = "ai.jaak.kyc.ACTION_RETRY_SYNC"
        const val ACTION_CANCEL_SYNC = "ai.jaak.kyc.ACTION_CANCEL_SYNC"
        const val ACTION_VIEW_DETAILS = "ai.jaak.kyc.ACTION_VIEW_DETAILS"
        const val ACTION_SYNC_ALL = "ai.jaak.kyc.ACTION_SYNC_ALL"
