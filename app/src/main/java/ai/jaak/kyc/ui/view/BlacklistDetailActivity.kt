...
import ai.jaak.kyc.data.model.DataRow
import ai.jaak.kyc.databinding.ActivityBlacklistDetailBinding
import ai.jaak.kyc.ui.adapter.BlacklistAdapter
...
class BlacklistDetailActivity : AppCompatActivity() {
    ...
    private fun loadBlacklistData() {
        ...
        val blacklistData = intent.getParcelableExtra<ai.jaak.kyc.data.model.BlacklistDetailData>("blacklist_data")
