...
import ai.jaak.kyc.databinding.ActivityDocumentDetailBinding
import ai.jaak.kyc.ui.adapter.VerificationResult
import ai.jaak.kyc.ui.adapter.VerificationResultsAdapter
...
class DocumentDetailActivity : AppCompatActivity() {
    ...
    private fun loadDocumentDetailData() {
        ...
        val documentData = intent.getParcelableExtra<ai.jaak.kyc.data.model.DocumentDetailData>("document_data")
     ...
     */
    private fun parseVerificationResults(documentData: ai.jaak.kyc.data.model.DocumentDetailData) {
    ...
    private fun generateVerificationResults(event: ai.jaak.kyc.data.model.api.SessionDetailFlowEvent): List<VerificationResult> {
        val results = mutableListOf<VerificationResult>()
