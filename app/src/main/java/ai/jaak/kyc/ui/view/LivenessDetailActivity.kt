...
import ai.jaak.kyc.databinding.ActivityLivenessDetailBinding
...
class LivenessDetailActivity : AppCompatActivity() {
    ...
    private fun loadLivenessData() {
        ...
        val livenessData = intent.getParcelableExtra<ai.jaak.kyc.data.model.LivenessDetailData>("liveness_data")
